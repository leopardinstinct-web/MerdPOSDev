(function(){
  ...
  function ensureShellAssets(){
    ...
    if(!document.querySelector('link[data-account-menu-css]')){
      const link=document.createElement('link');link.rel='stylesheet';link.href='assets/account-menu.css?v=20260826a';link.dataset.accountMenuCss='1';document.head.appendChild(link);
    }
    if(!document.querySelector('script[data-account-menu]')){
      const script=document.createElement('script');script.src='assets/account-menu.js?v=20260826a';script.dataset.accountMenu='1';document.body.appendChild(script);
    }
