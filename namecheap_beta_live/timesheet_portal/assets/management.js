(function(){
  ...
  function ensureShellAssets(){
    ...
    // Minimal-clutter interaction standard: all Add actions are one circular +;
    // all search fields begin as a circular magnifier and expand on demand.
