(function(){
  ...
  function ensureShellAssets(){
    ...
    if(can('dashboard.view')&&document.getElementById('dashboardPanel')){
      ...
      appendStyle('dashboard-builder-css','assets/dashboard-builder.css?v=20260831analytics2');
      appendScript('dashboard-builder','assets/dashboard-builder.js?v=20260831analytics2');
    }
    ...
    if(isDev){
      appendStyle('merd-ui-studio-css','assets/ui-studio.css?v=20260831studio29');
      appendScript('merd-ui-studio','assets/ui-studio.js?v=20260831studio29');
    }
  }
  ensureShellAssets();
