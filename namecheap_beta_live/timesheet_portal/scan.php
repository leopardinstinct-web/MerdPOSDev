...
<body class="login-body merd-login-body merd-shell">
  <main class="login-shell">
    <section class="login-card scan-card merd-login-card" aria-live="polite" aria-labelledby="attendanceTitle">
      <div class="merd-logo-lockup merd-brand" aria-label="MERDPOS">
        <img class="merd-brand__mark" src="assets/brand/merdpos-mark.svg" alt="" aria-hidden="true" width="44" height="44">
