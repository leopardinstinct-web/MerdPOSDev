...
$timesheetLogic=file_get_contents($root.'/timesheet_portal/includes/timesheet_logic.php');
att_reconcile_check(is_string($workforce) && is_string($timesheet) && is_string($fixture) && is_string($timesheetLogic),'Attendance reconciliation sources unavailable.');
