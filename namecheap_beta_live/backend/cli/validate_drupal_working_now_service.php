...
$constantSecret = str_repeat('c', 32);
define('MERDPOS_DRUPAL_SERVICE_SECRET', $constantSecret);
$constantServer = $server;
$constantServer['HTTP_X_MERDPOS_SIGNATURE'] = merd_service_sign('working_now', 'GET', $now, 1, '1001', $constantSecret);
$constantAuth = merd_service_authenticate($constantServer, 'working_now', $now);
check($constantAuth['actor_user_id'] === '1001', 'Private config constant secret failed');
