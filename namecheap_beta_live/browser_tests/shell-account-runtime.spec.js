...
test('DEV role preview is universal across shell and API permission context', async () => {
  ...
  expect(source).toContain('assets/management.js?v=20260902studio30');
