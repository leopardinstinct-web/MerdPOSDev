...
if (!str_contains($tokens, '--color-warning: #8A5300') || !str_contains($tokens, '--color-amber: var(--color-warning)')) $errors[] = 'global Amber semantic alias / stable warning token missing';
