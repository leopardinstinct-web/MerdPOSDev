...
dui_check(str_contains($account, "'active_client_id'")&&substr_count($account, "set('merdpos_context_client_id', \$activeClientId)")>=2,'Working User selection/exit must pin the paired Working Client in the Drupal session.');
