...
foreach(['data-query-root','data-timesheet-menu-choice="query"','Query this shift','data-timesheet-menu-choice="missing"','Add missing shift','data-clock-in-local','data-clock-out-local','data-query-shift-preview','Submit Query','data-query-notice','data-query-active-value'] as $needle) query_v1_check(str_contains($template,$needle),'Timesheet Query UI missing: '.$needle);
