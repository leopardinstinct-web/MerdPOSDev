...
dashboard_v2_check(str_contains($template,'merdpos-dashboard-filters--hero')&&str_contains($template,'aria-label="Dashboard period"'),'Period selector is not in the Dashboard hero.');
