...
rich_check(str_contains($twig, 'Administration') && str_contains($twig, 'Reports') && str_contains($twig, 'Financials') && str_contains($twig, 'DEV'), 'Rich capability graphics missing.');
