...
| DEV UI Studio | Source contract forbids network/mutation ownership and third-party circular runtimes; Chrome smoke checks actual-DEV gating, native Popover radial editing, locally vendored Google Material Symbols, text patches, cross-panel matching/reveal, draggable viewport-safe placement, nested palette/layout/scope layers, move patches, all-pages scope and Copy/Chat handoff | Permanent tooling/safety contract |
