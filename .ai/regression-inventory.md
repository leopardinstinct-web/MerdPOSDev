...
| DEV UI Studio | Source contract forbids network/mutation ownership; Chrome smoke checks actual-DEV gating, preview style edits, element move patches and structured change-set output | Permanent tooling/safety contract |
